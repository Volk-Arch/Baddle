...
Каждый регион — целевой профиль (DA, 5HT, NE, ACh, GABA) ∈ [0,1]⁵. Nearest
по L2-расстоянию в 5D пространстве.
...
который про синхронизацию с системой). Profile notation: ↑↑↑=1.0, ↑↑=0.85,
↑=0.7, ↗=0.6, ↔=0.5, ↘=0.4, ↓=0.3, ↓↓=0.15, ↓↓↓=0.0.
